...
set "GITHUB_RELEASE_URL=https://github.com/Karmine-gh/Zapret-personal/releases/tag/"
set "GITHUB_DOWNLOAD_URL=https://github.com/Flowseal/zapret-discord-youtube/releases/latest/download/zapret"
